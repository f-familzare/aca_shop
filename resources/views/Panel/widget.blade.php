...
<body>
                        ...
                        <aside class="profile-nav alt green-border">
                            <section class="panel">
                                <div class="user-heading alt green-bg">
                                    <a href="#">
                                        <img alt="" src="../../../public/Panel/img/profile-avatar.jpg">
                                    </a>
                            ...
                            <div class="col-lg-6">
                                ...
                                <section class="panel">
                                    <div class="twt-feed blue-bg">
                                        ...
                                        <p>jsmith@flatlab.com</p>
                                        <a href="#">
                                            <img src="../../../public/Panel/img/profile-avatar.jpg" alt="">
                                        </a>
                                    </div>
                                    ...
                                    <div class="panel-body">
                                        <div class="tab-content tasi-tab">
                                            <div class="tab-pane active" id="popular">
                                                <article class="media">
                                                    <a class="pull-left thumb p-thumb">
                                                        <img src="../../../public/Panel/img/product1.jpg">
                                                    </a>
                                                ...
                                                <article class="media">
                                                    <a class="pull-left thumb p-thumb">
                                                        <img src="../../../public/Panel/img/product2.png">
                                                    </a>
                                                    <div class="media-body">
                                                ...
                                                <article class="media">
                                                    <a class="pull-left thumb p-thumb">
                                                        <img src="../../../public/Panel/img/product3.png">
                                                    </a>
                                                    <div class="media-body">
                                            ...
                                            <div class="tab-pane" id="comments">
                                                <article class="media">
                                                    <a class="pull-left thumb p-thumb">
                                                        <img src="../../../public/Panel/img/avatar-mini.jpg">
                                                    </a>
                                                    <div class="media-body">
                                                ...
                                                <article class="media">
                                                    <a class="pull-left thumb p-thumb">
                                                        <img src="../../../public/Panel/img/avatar-mini2.jpg">
                                                    </a>
                                                    <div class="media-body">
                                                ...
                                                <article class="media">
                                                    <a class="pull-left thumb p-thumb">
                                                        <img src="../../../public/Panel/img/avatar-mini3.jpg">
                                                    </a>
                                                    <div class="media-body">
                                ...
                                <div class="timeline-messages">
                                    ...
                                    <div class="msg-time-chat">
                                        <a href="#" class="message-img">
                                            <img class="avatar" src="../../../public/Panel/img/chat-avatar.jpg" alt=""></a>
                                    ...
                                    <div class="msg-time-chat">
                                        <a href="#" class="message-img">
                                            <img class="avatar" src="../../../public/Panel/img/chat-avatar2.jpg" alt=""></a>
    ...
    <script src="../../../public/Panel/assets/jquery-knob/js/jquery.knob.js"></script>
